FactoryBot.define do
  ...
  factory :second_record, class: NutritionRecord do
    ...
    after(:build) do |second_record|
      second_record.nutrition_record_lines << FactoryBot.build(:second_nutrition_record_line,
                                                               nutrition_record: second_record)
      second_record.nutrition_record_lines << FactoryBot.build(:fifth_nutrition_record_line,
                                                               nutrition_record: second_record)
    end
  end
  ...
  factory :third_record, class: NutritionRecord do
    ...
    after(:build) do |third_record|
      third_record.nutrition_record_lines << FactoryBot.build(:third_nutrition_record_line,
                                                              nutrition_record: third_record)
    end
  end
  ...
  factory :fourth_record, class: NutritionRecord do
    ...
    after(:build) do |fourth_record|
      fourth_record.nutrition_record_lines << FactoryBot.build(:fourth_nutrition_record_line,
                                                               nutrition_record: fourth_record)
    end
  end
  ...
  factory :fifth_record, class: NutritionRecord do
    ...
    after(:build) do |fifth_record|
      fifth_record.nutrition_record_lines << FactoryBot.build(:fifth_nutrition_record_line,
                                                              nutrition_record: fifth_record)
    end
  end
  ...
  factory :sixth_record, class: NutritionRecord do
    ...
    after(:build) do |sixth_record|
      sixth_record.nutrition_record_lines << FactoryBot.build(:fifth_nutrition_record_line,
                                                              nutrition_record: sixth_record)
    end
  end
